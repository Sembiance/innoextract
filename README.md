...
**NOTE** This fork has been vibe coded to add support for additional, older innoextractors found on discmaster. The code changes were not hand-reviewed by a human
